...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (lsp-mode helm auto-package-update flycheck go-mode markdown-mode sql-indent elixir-mode web-mode use-package smartparens smart-mode-line rspec-mode obsidian-theme magit hydandata-light-theme highlight-numbers helm-projectile helm-ag flycheck-color-mode-line expand-region exec-path-from-shell enh-ruby-mode bundler ag))))
(custom-set-faces
